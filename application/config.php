...
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => 'wS?mLhHPOt}JlDA;In=frCi+5e1V(#UR-":|[2)y', //默认数据加密KEY
	'data_cache_key'=> 'wS?mLhHPOt}JlDA;In=frCi+5e1V(#UR-":|[2)y',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>'wS?mLhHPOt}JlDA;In=frCi+5e1V(#UR-":|[2)y', //加密KEY
