<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"D:\phpStudy\WWW\twothink\public/../application/admin/view/default/repair\edit.html";i:1506675851;s:82:"D:\phpStudy\WWW\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
	...
	<div class="main">
		<h2>
			...
			<?php if(!(empty($pid) || (($pid instanceof \think\Collection || $pid instanceof \think\Paginator ) && $pid->isEmpty()))): ?>"><?php echo $parent; ?></a>&nbsp;]
			<?php endif; ?>
		</h2>
	</div>
	<form action="<?php echo url(); ?>" method="post" class="form-horizontal">
		...
		<div class="form-item">
			...
			<div class="controls">
				<input type="text" class="text input-large" name="city" value="<?php echo (isset($info['city']) && ($info['city'] !== '')?$info['city']:''); ?>">
			</div>
		</div>
		<div class="form-item">
			<label class="item-label">标题<span class="check-tips"></span></label>
			<div class="controls">
				<input type="text" class="text input-large" name="tro" value="<?php echo (isset($info['tro']) && ($info['tro'] !== '')?$info['tro']:''); ?>">
			</div>
		</div>
		<div class="form-item">
